...
class NavigationBarAdminView extends StatelessWidget {
  const NavigationBarAdminView({super.key});
          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              ...
              child: BottomNavigationBar(
                currentIndex: (navigationCubit.state as NavigationAdminInitial)
                    .currentIndex,
                onTap: (int index) {
                  switch (index) {
                    case 0:
